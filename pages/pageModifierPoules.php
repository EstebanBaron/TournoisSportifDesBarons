...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/styleModifierPoules.css" />
        <script
            ...
            <div id="ContentantDesPoules">
                ...
                while ($indexToNbPoules < $nbPoules) {  //pour toutes les poules séparé par des virgules
                    ...
                    while ($equipes[$indexToNbEquipe]) { //pour chaque équipe de la poule
                        echo '<div id="equipe' . ($indexToNbEquipe+1) . 'Poule' . ($indexToNbPoules+1) . '" draggable="true" ondragstart="onDragStart(event);">'; //ex : equipe1Poule1
